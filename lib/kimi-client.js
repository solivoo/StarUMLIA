...
function getConfig() {
  return {
    ...
    model: app.preferences.get("kimi.model") || "kimi-k3",
    temperature: Number(app.preferences.get("kimi.temperature") || 0.2),
    reasoningEffort: app.preferences.get("kimi.reasoningEffort") || "low"
  };
}
...
function chat(messages) {
  ...
  // Kimi K3 usa reasoning_effort (low|high|max). Docs: platform.kimi.ai/docs/overview
  if (String(cfg.model).indexOf("kimi-k3") === 0) {
